<template>
  <header>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li>
          <p>
            ...
            <nuxt-link class="btn log-btn my-2 my-sm-0 my-account" :to="Linkauth()">
              <img src="/img/Icons-icon-settings.svg" alt="" />
              Mi Cuenta
            </nuxt-link>
          </p>
    ...
    <li class="nav-item border-bottom">
          <NuxtLink class="nav-link" :to="localePath('/por-mayor')" tabindex="-1">{{ $t('menu.porMayor') }}<span><img src="/img/path.svg" alt=""></span></NuxtLink>
    </li>
      <li class="nav-item border-bottom">
  ...
  <div id="main">
    <nav class="navbar navbar-light fixed-top bg-light openbtn">
      ...
      <button type="button" class="btn flex gap-1" @click="viewCart">
