...
export default {
  ...
  head() {
    return {
      title: "Recetas de Ajo Negro | Cómo Cocinar con Ajo Negro para Energía Natural",
      link: [
        {
          rel: 'canonical',
          href: 'https://kokorofoods.cl/es/recetas'
        }
      ],
      meta: [
        {
          name: "description",
          content:
            "Descubre nuestras deliciosas y fáciles recetas de ajo negro. Aprende cómo cocinar con este superalimento para obtener un impulso natural de energía y salud",
        },
        {
          hid: "description",
          name: "description",
          content: "Descubre nuestras deliciosas y fáciles recetas de ajo negro. Aprende cómo cocinar con este superalimento para obtener un impulso natural de energía y salud",
        },
        {
          hid: "og:title",
          name: "og:title",
          content: "Recetas de Ajo Negro | Cómo Cocinar con Ajo Negro para Energía Natural",
        },
        {
          hid: "og:description",
          name: "og:description",
  ...
  methods: {
    ...
    seleccionada: function (id) {
      ...
      var filtrado = "http://api.kokorofoods.cl/api/main/recipes/?";
