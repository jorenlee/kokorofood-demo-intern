<template>
  <main role="main">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>
                Al parecer estas intentando agregar un producto de otra tienda que no
                corresponde a tu pais
              </p>
    ...
    <section class="w-11/12 mx-auto" v-if="!mobile">
      <div class="row featurette">
        <div class="col-md-7 order-md-2 px-5 my-24">
          <div class="description" v-html="ProductData.description"></div>
          <p v-if="ProductData.quantity > 0" class="my-3.5">
            <button
              class="btn btn-cart"
              @click="
                addProductToCart({
          ...
          <div class="row info-block">
            <!--row2-->
            <div
              class="col-md-12 row pt-3 pb-2"
              v-html="this.$t('ProductPage.Benefits')"
            ></div>
          </div>
        </div>
        <div class="col-md-5 order-md-1 my-24">
          <p>
            <NuxtLink class="btn btn-lg btn-primary" :to="localePath('/productos')">{{
              $t("Buttons.Back")
            }}</NuxtLink>
          </p>
          ...
          <p class="precio">
            <strong>
              {{ $t("general.price") }}:
              <span>{{ $n(ProductData.discount_price, "currency") }}</span></strong
            >
          </p>
    ...
    <section class="w-11/12 mx-auto mt-5 p-0" v-if="mobile">
      <div class="row featurette p-0">
        <div class="col-12 p-0">
          ...
          <p class="precio pl-4 pr-5">
            {{ $t("ProductPage.price") }}:
            <span>${{ $n(ProductData.discount_price, "currency") }}</span>
          </p>
          ...
          <div class="col-12 p-0 info-articulo pt-3">
            ...
            <p v-if="ProductData.quantity < 1">
              <button class="btn btn-lg btn-light center-button-2 mt-3 mb-3 disabled">
                {{ $t("Buttons.addtocart") }}
              </button>
            </p>
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          ...
          name: "og:image",
          content:
            this.ProductData.product_images.length &&
            this.ProductData.product_images[0].image_url,
        },
        {
          hid: "og:url",
          name: "og:url",
