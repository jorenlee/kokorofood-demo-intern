            ...
            <div class="col-12 p-0 m-0 row">
              ...
              <div class="col-6 p-0 mt-0 mb-0">
                <div class="col-8 articulo row">
                  <div class="col-12">
                    <p class="n-articulo mb-4">{{ item.product.name }}</p>
                    <div class="precio-oferta col-12 cantidad-info">
                      ...
                      <h4>
                        <span
                          ><strong>${{ item.product.discount_price }}</strong></span
                        >
                      </h4>
                    </div>
                  </div>
                  ...
                  <div class="col-12 p-0">
                    <div class="precio-oferta col-12 cantidad-info">
                      <div class="table-price col-12">
                        ...
                        <h4 class="w-6/12 py-2 flex items-center">
                      ...
                      <div class="table-price col-12">
                        <p class="total pr-3">
                         ...
                         <h4 class="w-6/12 py-2 flex items-center lg:text-xl text-base font-bold pt-2">
                          ${{ TotalPrice.total }}
                        </h4>
                      </div>
                    </div>
