      ...
      <div class="row p-0">
        ...
        <div class="col-md-5 mb-1 order-md-2 order-2">
          <div class="mb-0 pb-5" style="background-color: #f6f0ee">
            <div class="mb-5" style="background-color: #d5441c">
              <p
            ...
            <form class="mt-5 px-4 pb-5 pt-3">
              ...
              <div class="d-flex flex-wrap">
                <p class="bg-peach mt-2 pb-1 w-auto font-bold" style="font-size:16px; padding: 0 10px 0 0;">Despacho</p>
                <div
                  class="col border-dark border-top border-2" style="margin: 20px 0 0 0;"
                ></div>
              </div>
              <div class="d-flex flex-wrap">
                <input
