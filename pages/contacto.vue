...
export default {
    ...
    head() {
		return {
		title: "Contáctanos | Kokorofoods",
		meta: [
			{
			name: "description",
			content:
				"¿Quieres saber más sobre el ajo negro? Contáctanos. Estamos aquí para responder a todas tus preguntas.",
			},
			{
			hid: "description",
			name: "description",
			content: "¿Quieres saber más sobre el ajo negro? Contáctanos. Estamos aquí para responder a todas tus preguntas.",
			},
			{
			hid: "og:title",
			name: "og:title",
			content: "Contáctanos | Kokorofoods",
			},
			{
			hid: "og:description",
			name: "og:description",
